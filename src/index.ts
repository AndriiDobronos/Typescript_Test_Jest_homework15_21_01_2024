...
// застосунку,який полегшить управління бізнесом.
//
// Нижче опис сутностей, які є на даний момент. Сприймайте це не
// як чітке ТЗ, а скоріше як підказки, які допоможуть в побудові
// програми. Ви вільні трактувати опис на свій розсуд, вибирати
// шаблони програмування (не обов'язково лише ті, що ми з вами розглянули)
// та підходи, будувати архітектуру, яка на ваш розсуд буде найбільш оптимальною.
//
// Плюсом буде, якщо ви залишите коментарі до свого коду.
// (Наприклад: "Тут я використав патерн Сінглтон, тому що....")
//
// Проєкт "Зоопарк":
//
// "Каса":
...
//
// Відділ реклами використовує цей список для розсилки новин про
// зоопарк і рекламні акції.
//
// "Відділ реклами":
//
...
// "Тварини":
//
// Включає в себе інформацію про кожну тварину, таку як вид, ім'я,
// вік, здоров'я та інші характеристики.
//
// "Співробітники":
//
...
// Для побудови застосунку використаем патерн проєктування "Fasade"

import {ZooFacade} from "./classes/ZooFacade";

// Використання фасаду
const zooFacade = new ZooFacade();
zooFacade.sellTicket("Alice", "alice@email.com", "Adult", 20);
zooFacade.sellTicket("Bob", "bob@email.com", "Child", 10);
zooFacade.closeZoo();
zooFacade.manageEmployeesAndAnimals();
zooFacade.manageBudgetAndReports();
